...
#
# The provided Python script will be the same one used to test your implementation. The script runs one of the two
...
#       then Assign1-s1234/nearest_neigh_file_based.py should exist.
#   name of implementation to test: This is the name of the implementation to test.  The names
#       should be the same as specified in the script or in nearest_neigh_file_based.py. E.g.- naive or kdtree
...
#       E.g. if the script is in the directory path /home/s1234/assign1TestScript.py and
...
def main():
    ...
    # python file to run
    sExec = "nearest_neigh_file_based.py"
